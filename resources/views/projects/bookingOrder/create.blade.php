...
<div class="container mt-4">
    <form action="{{ route('projects.logistics.booking-orders.store', $project->id) }}" method="POST" class="needs-validation" novalidate>
        @csrf
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            <div>
                ...
                <a href="{{ route('projects.logistics.booking-orders.index', $project->id) }}" class="btn btn-secondary me-2">
